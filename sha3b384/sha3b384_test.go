...
import (
	...
	"github.com/mengzhuo/go-kcapi/sha3b384"
)

func TestSHashSHA3B384(t *testing.T) {
...
func TestSHashSHA3B384File(t *testing.T) {
	kh, err := sha3b384.New()
	if err != nil {
		t.Skip(err)
	}
...
func BenchmarkSHashSHA3B384File(b *testing.B) {
