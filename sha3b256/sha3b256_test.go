...
import (
	...
	"github.com/mengzhuo/go-kcapi/sha3b256"
)

func TestSHashSHA3B256(t *testing.T) {
...
func TestSHashSHA3B256File(t *testing.T) {
	kh, err := sha3b256.New()
	if err != nil {
		t.Skip(err)
	}
...
func BenchmarkSHashSHA3B256File(b *testing.B) {
